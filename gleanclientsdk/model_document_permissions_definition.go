...
// checks if the DocumentPermissionsDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentPermissionsDefinition{}
...
func (o *DocumentPermissionsDefinition) GetAllowedGroupIntersections() []PermissionsGroupIntersectionDefinition {
	if o == nil || IsNil(o.AllowedGroupIntersections) {
...
func (o *DocumentPermissionsDefinition) GetAllowAllDatasourceUsersAccess() bool {
	if o == nil || IsNil(o.AllowAllDatasourceUsersAccess) {
		var ret bool
		return ret
	}
...
func (o DocumentPermissionsDefinition) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AllowedGroupIntersections) {
	...
	if !IsNil(o.AllowAllDatasourceUsersAccess) {
