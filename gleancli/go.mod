...
require (
	...
	cloudeng.io/glean/config v0.0.0-20230309194432-96d1e1ac104b
	cloudeng.io/glean/crawlindex v0.0.0-20230309194432-96d1e1ac104b
)

require (
	cloudeng.io/algo v0.0.0-20230309184059-9263072b1423 // indirect
	cloudeng.io/errors v0.0.8 // indirect
	cloudeng.io/glean/gleansdk v0.0.0-20230309194432-96d1e1ac104b // indirect
	...
	cloudeng.io/webapi/operations v0.0.0-20230308055554-e5fc3219a959 // indirect
